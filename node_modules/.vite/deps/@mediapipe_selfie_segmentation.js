    ...
    (function() {
      ...
      J("Promise", function(a) {
        ...
        b.prototype.s = function(e, g) {
          if (0 != this.h)
            throw Error("Cannot settle(" + e + ", " + g + "): Promise already settled in state" + this.h);
          this.h = e;
          this.i = g;
          2 === this.h && this.D();
          this.A();
        ...
        b.prototype.B = function() {
          if (this.o)
            return false;
          var e = H.CustomEvent, g = H.Event, k = H.dispatchEvent;
          if ("undefined" === typeof k)
            return true;
          "function" === typeof e ? e = new e("unhandledrejection", { cancelable: true }) : "function" === typeof g ? e = new g("unhandledrejection", { cancelable: true }) : (e = H.document.createEvent("CustomEvent"), e.initCustomEvent("unhandledrejection", false, true, e));
          e.promise = this;
          e.reason = this.i;
          return k(e);
        };
        ...
        b.all = function(e) {
          ...
          return k.done ? d([]) : new b(function(l, q) {
            ...
            var w = [], t = 0;
            do
              w.push(void 0), t++, d(k.value).J(v(w.length - 1), q), k = g.next();
            while (!k.done);
          });
        };
        return b;
      ...
      var Aa, Ba = "undefined" !== typeof TextDecoder, Ca, Da = "undefined" !== typeof TextEncoder;
      function Ea(a) {
        if (Da)
          a = (Ca || (Ca = new TextEncoder())).encode(a);
        else {
          var b = void 0;
          b = void 0 === b ? false : b;
          for (var c = 0, d = new Uint8Array(3 * a.length), f = 0; f < a.length; f++) {
      ...
      function Ha(a, b) {
        ...
        Ja();
        b = Fa[b];
        for (var c = Array(Math.floor(a.length / 3)), d = b[64] || "", f = 0, h = 0; f < a.length - 2; f += 3) {
          var e = a[f], g = a[f + 1], k = a[f + 2], l = b[e >> 2];
          e = b[(e & 3) << 4 | g >> 4];
          g = b[(g & 15) << 2 | k >> 6];
          k = b[k & 63];
          c[h++] = l + e + g + k;
      ...
      function La(a, b) {
        ...
        Ja();
        for (var d = 0; ; ) {
          var f = c(-1), h = c(0), e = c(64), g = c(64);
          if (64 === g && -1 === f)
            break;
          b(f << 2 | h >> 4);
          64 != e && (b(h << 4 & 240 | e >> 2), 64 != g && b(e << 6 & 192 | g));
        }
      }
      function Ja() {
        if (!Ga) {
      ...
      ;
      var Ma = "function" === typeof Uint8Array.prototype.slice, Na;
      function Oa(a, b, c) {
        return b === c ? Na || (Na = new Uint8Array(0)) : Ma ? a.slice(b, c) : new Uint8Array(a.subarray(b, c));
      }
      var P = 0, Q = 0;
      function Pa(a, b) {
        b = void 0 === b ? {} : b;
      ...
      function Qa(a, b) {
        b = b.constructor === Uint8Array ? b : b.constructor === ArrayBuffer ? new Uint8Array(b) : b.constructor === Array ? new Uint8Array(b) : b.constructor === String ? Ka(b) : b instanceof Uint8Array ? new Uint8Array(b.buffer, b.byteOffset, b.byteLength) : new Uint8Array(0);
        a.h = b;
        a.j = 0;
        a.i = a.h.length;
        a.g = a.j;
      ...
      function Ua(a) {
        ...
        this.N = c;
        b = this.o;
        Sa.length ? (c = Sa.pop(), b && (c.v = b.v), a && Qa(c, a), a = c) : a = new Pa(a, b);
        this.g = a;
        this.m = this.g.g;
      ...
      function Ya(a) {
        ...
        var d;
        if (Ba)
          (d = Aa) || (d = Aa = new TextDecoder("utf-8", { fatal: false })), d = d.decode(a.subarray(c, c + b));
        else {
          b = c + b;
          for (var f = [], h = null, e, g, k; c < b; )
            e = a[c++], 128 > e ? f.push(e) : 224 > e ? c >= b ? f.push(65533) : (g = a[c++], 194 > e || 128 !== (g & 192) ? (c--, f.push(65533)) : f.push((e & 31) << 6 | g & 63)) : 240 > e ? c >= b - 1 ? f.push(65533) : (g = a[c++], 128 !== (g & 192) || 224 === e && 160 > g || 237 === e && 160 <= g || 128 !== ((d = a[c++]) & 192) ? (c--, f.push(65533)) : f.push((e & 15) << 12 | (g & 63) << 6 | d & 63)) : 244 >= e ? c >= b - 2 ? f.push(65533) : (g = a[c++], 128 !== (g & 192) || 0 !== (e << 28) + (g - 144) >> 30 || 128 !== ((d = a[c++]) & 192) || 128 !== ((k = a[c++]) & 192) ? (c--, f.push(65533)) : (e = (e & 7) << 18 | (g & 63) << 12 | (d & 63) << 6 | k & 63, e -= 65536, f.push((e >> 10 & 1023) + 55296, (e & 1023) + 56320))) : f.push(65533), 8192 <= f.length && (h = za(h, f), f.length = 0);
          d = za(h, f);
        }
        return d;
      }
      ...
      function T(a, b, c) {
        if (null != c) {
          ...
          var d = c;
          d = (c = 0 > d ? 1 : 0) ? -d : d;
          0 === d ? 0 < 1 / d ? P = Q = 0 : (Q = 0, P = 2147483648) : isNaN(d) ? (Q = 0, P = 2147483647) : 34028234663852886e22 < d ? (Q = 0, P = (c << 31 | 2139095040) >>> 0) : 11754943508222875e-54 > d ? (d = Math.round(d / Math.pow(2, -149)), Q = 0, P = (c << 31 | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2), d *= Math.pow(2, -b), d = Math.round(8388608 * d) & 8388607, Q = 0, P = (c << 31 | b + 127 << 23 | d) >>> 0);
          c = P;
          a.push(c >>> 0 & 255);
          a.push(c >>> 8 & 255);
          a.push(c >>> 16 & 255);
      ...
      function cb(a, b, c) {
        if (null != a)
          return "object" === typeof a ? bb && a instanceof Uint8Array ? c(a) : db(a, b, c) : b(a);
      }
      function db(a, b, c) {
        if (Array.isArray(a)) {
      ...
      var gb = { W: { value: true, configurable: true } };
      function eb(a) {
      ...
      function U(a, b, c) {
        ...
        if (c)
          for (b = 0; b < c.length; b++)
            a = c[b], a < this.l ? (a += this.j, (d = this.g[a]) ? eb(d) : this.g[a] = ib) : (jb(this), (d = this.h[a]) ? eb(d) : this.h[a] = ib);
      }
      ...
      function mb(a, b, c, d) {
        ...
        b = b ? b : new c();
        a = kb(a);
        void 0 != d ? (f.splice(d, 0, b), a.splice(d, 0, nb(b, false))) : (f.push(b), a.push(nb(b, false)));
      }
      ...
      function Cb(a) {
        return lb(a, sb).map(function(b) {
          return { index: ob(b, 1), Y: X(b, 2), label: null != V(b, 3) ? pb(b, 3) : void 0, displayName: null != V(b, 4) ? pb(b, 4) : void 0 };
        });
      }
      ;
      function Db(a) {
      ...
      function Gb(a, b) {
        ...
        if (void 0 === a.m) {
          ...
          a.j = { I: c.getAttribLocation(d, "aVertex"), H: c.getAttribLocation(d, "aTex"), da: f };
          a.s = c.createBuffer();
      ...
      ;
      var Ib = new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 9, 1, 7, 0, 65, 0, 253, 15, 26, 11]);
      function Jb(a, b) {
        return b + a;
      }
      function Kb(a, b) {
      ...
      function Pb(a) {
        return Y(a, function c() {
          var d = this, f, h, e, g, k, l, q, v, w, t, y;
          return O(c, function(m) {
            switch (m.g) {
              ...
              case 2:
                e = m.h;
                if ("object" === typeof window)
                  return Kb("createMediapipeSolutionsWasm", { locateFile: d.locateFile }), Kb("createMediapipeSolutionsPackedAssets", { locateFile: d.locateFile }), l = h.filter(function(u) {
                    return void 0 !== u.data;
                  }), q = h.filter(function(u) {
                    return void 0 === u.data;
                  }), v = Promise.all(l.map(function(u) {
                    var x = Qb(f, u.url);
                    if (void 0 !== u.path) {
                      var z = u.path;
                      x = x.then(function(E) {
                    ...
                    return x;
                  })), w = Promise.all(q.map(function(u) {
                    return void 0 === u.simd || u.simd && e || !u.simd && !e ? Lb(f.locateFile(u.url, f.S)) : Promise.resolve();
                  })).then(function() {
                    return Y(f, function x() {
                      var z, E, F = this;
                      return O(x, function(K) {
                        if (1 == K.g)
                          return z = window.createMediapipeSolutionsWasm, E = window.createMediapipeSolutionsPackedAssets, N(K, z(E), 2);
                        F.h = K.h;
                        K.g = 0;
                      });
                    });
                    ...
                    return Y(f, function x() {
                      ...
                      return O(x, function(E) {
                        z.g.graph && z.g.graph.url ? E = N(E, Qb(z, z.g.graph.url), 0) : (E.g = 0, E = void 0);
                        return E;
                      });
                    });
      ...
      D.setOptions = function(a, b) {
        ...
        if (b = b || this.g.options) {
          for (var d = [], f = [], h = {}, e = M(Object.keys(a)), g = e.next(); !g.done; h = { K: h.K, L: h.L }, g = e.next()) {
            var k = g.value;
            k in this.j && this.j[k] === a[k] || (this.j[k] = a[k], g = b[k], void 0 !== g && (g.onChange && (h.K = g.onChange, h.L = a[k], d.push(function(l) {
              return function() {
            ...
            }(h))), g.graphOptionXref && (k = { valueNumber: 1 === g.type ? a[k] : 0, valueBoolean: 0 === g.type ? a[k] : false, valueString: 2 === g.type ? a[k] : "" }, g = Object.assign(Object.assign(Object.assign({}, { calculatorName: "", calculatorIndex: 0 }), g.graphOptionXref), k), f.push(g))));
          }
          if (0 !== d.length || 0 !== f.length)
            this.o = true, this.A = (void 0 === this.A ? [] : this.A).concat(f), this.u = (void 0 === this.u ? [] : this.u).concat(d);
        }
      };
      function Tb(a) {
        return Y(a, function c() {
          var d = this, f, h, e, g, k, l, q;
      ...
      D.initialize = function() {
        return Y(this, function b() {
          var c = this;
          return O(b, function(d) {
            return 1 == d.g ? N(d, Pb(c), 2) : 3 != d.g ? N(d, Rb(c), 3) : N(d, Tb(c), 0);
          });
        });
      };
      function Qb(a, b) {
              ...
              case 3:
                ...
                for (k = g.next(); !k.done; k = g.next())
                  if (l = k.value, q = f.g.inputs[l]) {
                      ...
                      switch (q.type) {
                        case "video":
                          ...
                          if ("undefined" !== typeof HTMLVideoElement && u instanceof HTMLVideoElement) {
                            ...
                            "undefined" !== typeof HTMLImageElement && u instanceof HTMLImageElement ? (z = u.naturalWidth, x = u.naturalHeight) : (z = u.width, x = u.height);
                        ...
                        case "detections":
                          ...
                          for (x = 0; x < u.length; ++x) {
                            z = u[x];
                            var E = m.data, F = E.setBoundingBox, K = x;
                            var I = z.T;
                            var r = new Ab();
                            W(r, 1, I.Z);
                            W(r, 2, I.$);
                            ...
                            if (null != C && null != C) {
                              ...
                              B >>>= 0;
                              C && (B = ~B >>> 0, n = (~n >>> 0) + 1, 4294967295 < n && (n = 0, B++, 4294967295 < B && (B = 0)));
                              P = n;
                              Q = B;
                              C = P;
                              for (n = Q; 0 < n || 127 < C; )
                                p.push(C & 127 | 128), C = (C >>> 7 | n << 25) >>> 0, n >>>= 7;
                              p.push(C);
                            }
                            qb(r, A);
                            I = ab(I);
                            ...
                            if (z.M)
                              for (E = 0; E < z.M.length; ++E) {
                                ...
                                T(p, 2, V(A, 2));
                                C = V(A, 3);
                                null != C && (C = Ea(C), S(p.g, 26), S(p.g, C.length), $a(p, p.g.end()), $a(p, C));
                                C = V(A, 4);
                                null != C && (C = Ea(C), S(p.g, 34), S(p.g, C.length), $a(p, p.g.end()), $a(
                                  p,
                                  C
                                ));
                                qb(A, p);
                    ...
                    switch (q.type) {
                      case "video":
                        e.pushTexture2d(Object.assign(Object.assign({}, v), { stream: w, timestamp: h }));
                        break;
                      case "detections":
                        t = v;
                        t.stream = w;
      ...
      function Ub(a, b, c) {
        return Y(a, function f() {
          var h, e, g, k, l, q, v = this, w, t, y, m, u, x, z, E;
          return O(f, function(F) {
            switch (F.g) {
              case 1:
                ...
                g = M(Object.keys(c));
                for (k = g.next(); !k.done; k = g.next())
                  l = k.value, q = c[l], "string" !== typeof q && "texture" === q.type && void 0 !== b[q.stream] && ++e;
                1 < e && (v.G = false);
                w = M(Object.keys(c));
                k = w.next();
              case 2:
                ...
                if ("detection_list" === y.type) {
                  if (m) {
                    var K = m.getRectList();
                    for (var I = m.getLandmarksList(), r = m.getClassificationsList(), A = [], C = 0; C < K.size(); ++C) {
                      var p = K.get(C);
                      a: {
                        var B = new Ab();
                        for (p = new Ua(p); Va(p); )
                          switch (p.i) {
                            ...
                            case 45:
                              ...
                              break;
                            case 48:
                              for (var G = p.g, L = 128, Ia = 0, Z = n = 0; 4 > Z && 128 <= L; Z++)
                                L = G.h[G.g++], Ia |= (L & 127) << 7 * Z;
                              128 <= L && (L = G.h[G.g++], Ia |= (L & 127) << 28, n |= (L & 127) >> 4);
                              if (128 <= L)
                                for (Z = 0; 5 > Z && 128 <= L; Z++)
                      ...
                      B = { Z: X(B, 1), $: X(B, 2), height: X(B, 3), width: X(B, 4), rotation: X(B, 5, 0), X: ob(B, 6) };
                      n = I.get(C);
                      a:
                        for (p = new yb(), n = new Ua(n); Va(n); )
                          switch (n.i) {
                            case 10:
                              G = Xa(n, new wb(), xb);
                              mb(p, G, wb, void 0);
                      ...
                      G = r.get(C);
                      a:
                        for (n = new ub(), G = new Ua(G); Va(G); )
                          switch (G.i) {
                            case 10:
                              n.addClassification(Xa(
                                G,
                                new sb(),
                                tb
                              ));
      ...
      function Vb(a, b, c) {
        return Y(a, function f() {
          ...
          return O(f, function(g) {
            return "number" === typeof c || c instanceof Uint8Array || c instanceof h.h.Uint8BlobList ? g.return(c) : c instanceof h.h.Texture2dDataOut ? (e = h.s[b], e || (e = new Eb(h.h, h.D), h.s[b] = e), g.return(Fb(e, c, h.G))) : g.return(void 0);
          });
        });
      }
      function Sb(a, b) {
        for (var c = b.name || "$", d = [].concat(ea(b.wants)), f = new a.h.StringList(), h = M(b.wants), e = h.next(); !e.done; e = h.next())
          f.push_back(e.value);
        h = a.h.PacketListener.implement({ onResults: function(g) {
          for (var k = {}, l = 0; l < b.wants.length; ++l)
            k[d[l]] = g.get(l);
          var q = a.listeners[c];
          q && (a.C = Ub(a, k, b.outs).then(function(v) {
            v = q(v);
            for (var w = 0; w < b.wants.length; ++w) {
              var t = k[d[w]];
              "object" === typeof t && t.hasOwnProperty && t.hasOwnProperty("delete") && t.delete();
            }
            v && (a.C = v);
          }));
        } });
      ...
      ya("Solution", Nb);
      ya("OptionType", { BOOL: 0, NUMBER: 1, aa: 2, 0: "BOOL", 1: "NUMBER", 2: "STRING" });
      function Wb(a) {
        void 0 === a && (a = 0);
        switch (a) {
          case 1:
      ...
      function Xb(a) {
        var b = this;
        a = a || {};
        this.g = new Nb({ locateFile: a.locateFile, files: function(c) {
          return [{ simd: true, url: "selfie_segmentation_solution_simd_wasm_bin.js" }, { simd: false, url: "selfie_segmentation_solution_wasm_bin.js" }, { data: true, url: Wb(c.modelSelection) }];
          ...
          return Y(b, function f() {
            ...
            return O(f, function(l) {
              if (1 == l.g)
                return h = Wb(c), e = "third_party/mediapipe/modules/selfie_segmentation/" + h, N(l, Qb(g.g, h), 2);
              k = l.h;
